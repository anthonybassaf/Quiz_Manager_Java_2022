...
public class TestDBConnection {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Connection connection = DriverManager.getConnection("jdbc:postgresql://localhost:5430/postgres", "postgres","postgres");
        ...
        String insertQuery = "INSERT INTO STUDENTS(id, name) values ('anthony.assaf@epita.fr', 'anthony')";
